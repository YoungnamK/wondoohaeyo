...
public class CoffeeListController extends SuperClass {
	...
	public ModelAndView doGet(HttpServletRequest request,
		...
		FlowParameters2 parameters = new FlowParameters2(pageNumber, pageSize, mode, keyword);

		System.out.println(this.getClass() + " : " + parameters.toString());
		int totalCount = cfdao.SelectTotalCount(parameters.getMode(), "%" + parameters.getKeyword() + "%");
		...
		// 해당 목록 가져오기
		List<Coffee> lists = this.cfdao.SelectAllData(pageInfo.getOffset(), pageInfo.getLimit(), parameters.getMode(),
