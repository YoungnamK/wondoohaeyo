	...
	<div class="panel panel-body">
		...
		<form enctype="multipart/form-data" method="post"
				...
				<div class="file-upload">
					...
					<c:if test="${whologin == 1}">
						<select class="form-control" name="sell_Status" id="sell_Status">
							...
							<c:if test="${bean.sell_Status == '대기중'}">
					...
					<div class="image-upload-wrap">
						<input name="sell_Pic" type="text" value="${bean.sell_Pic}">
						기존 이미지 : <input name="oldimg" type="text" value="${bean.sell_Pic}">
			...
			<div class="submit_btn col-sm-offset-3 col-sm-6">
				...
				<button class="appsubmit" type="submit" id="submit" name="submit">동의하고
					승인 신청하기</button>
			</div>
		</form>
	</div>
