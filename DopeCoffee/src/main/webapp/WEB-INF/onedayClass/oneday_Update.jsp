                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active  wow fadeInDown"  data-wow-duration="500ms" data-wow-delay="0.6s" role="tabpanel" id="step1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="type" id="type">
                                                            ...
                                                            <c:if test="${bean.type == 'coffee'}">
                                                            	<option class="form-control" value="coffee" selected="selected">커피</option>
                                                            </c:if>
                                                            <c:if test="${bean.type != 'coffee'}">
                                                            	<option class="form-control" value="coffee">커피</option>
                                                            </c:if>
                                                            <c:if test="${bean.type == 'pottery'}">
                                                            	<option class="form-control" value="pottery" selected="selected">도자기</option>
                                                            </c:if>
                                                            <c:if test="${bean.type != 'pottery'}">
                                                ...
                                                <div class="tab-pane" role="tabpanel" id="step2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        id="fake-startdate" name="fake-startdate" value="${bean.startdate}">
                                                        <input type="hidden" class="form-control" id="startdate" name="startdate" value="${bean.startdate}">
                                                    </div>
                                                    ...
                                                    <div class="pickercss">
	                                                    ...
	                                                    <input type="text" placeholder="마감일자" id="enddate" name="enddate" class="datepicker" onclick="date();" value="${bean.enddate}">
                                                    ...
                                                    <div class="pickercss">
                                                    	<div class="column_name">
	                                                     ...
	                                                     onclick="time();" value="${bean.opentime}">
                                                     ...
                                                     <div class="pickercss">
	                                                     ...
	                                                     onclick="time();" value="${bean.closetime}">
                                                    ...
                                                    <section id="add1">
                                                    	<div class="pickercss">
		                                                   ...
		                                                   onclick="time();" value="${bean.add_opentime1}">
	                                                    ...
	                                                    <div class="pickercss">
		                                                    ...
		                                                    onclick="time();"  value="${bean.add_closetime1}">
                                                    ...
                                                    <!-- ------------------------------------- [추가_오픈시간 2 add_opentime2 section]--------------------------------------- -->
                                                  		<div class="pickercss">
		                                                    ...
		                                                    onclick="time();" value="${bean.add_opentime2}">
	                                                    ...
	                                                    <div class="pickercss">
		                                                    ...
		                                                    <input type="text" placeholder="수업 마감시간(추가)" id="add_closetime2" name="add_closetime2" class="input_to timepicker"
		                                                     onclick="time();" value="${bean.add_closetime2}">
