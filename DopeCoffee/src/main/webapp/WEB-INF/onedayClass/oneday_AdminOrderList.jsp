...
<head>
	<meta charset="UTF-8">
	<title>원데이 클래스 관리자용 결제 목록</title>
					...
					<div class="block">
						...
						<div class="top">
							<h2 class="subtitle subtitle_css wow fadeInDown" data-wow-duration="500ms"
								data-wow-delay="0.3s">원데이 클래스 전체 수업 결제 현황</h2>
							<p class="subtitle-des wow fadeInDown" data-wow-duration="500ms"
								data-wow-delay="0.6s">전체 수업 결제 현황입니다!</p>
				        ...
				        <form id="contact-form search" method="get" action="${contextPath}/onedayAdminOrderlist.odc" role="form">
				        	<div id="search" class="search_css">
				               <select class="form-control" name="mode" id="mode" data-toggle="tooltip" title="검색할 조건을 선택하세요!">
				                      ...
				                      <option class="form-control" value="booktime">예약시간</option>
				                      <option class="form-control" value="code">클래스 코드</option>
				                      <option class="form-control" value="cust_email">회원 이메일</option>
				                      <option class="form-control" value="sell_email">사업자 이메일</option>
				               </select>
						...
						<%-- =========================
									중간 내용 부분 						
						==============================--%>
						<p id="list_top_css">총 ${requestScope.totalCount}건의 결제</p>
	      						...
	      						<table class="table table-bordered table-hover dt-responsive">
							        ...
							        <thead class="thead_css">
						                <tr>
						                    ...
						                    <th><spring:message code="oneday.cust_email_admin"/></th>
						                    <th><spring:message code="oneday.sell_email_admin"/></th>
