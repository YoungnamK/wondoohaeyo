...
<head>
	<meta charset="UTF-8">
	<title>원데이 클래스 사업자용 결제 목록</title>
					...
					<div class="block">
						...
						<div class="top">
							<h2 class="subtitle subtitle_css wow fadeInDown" data-wow-duration="500ms"
								data-wow-delay="0.3s">원데이 클래스 수업 결제 현황</h2>
							<p class="subtitle-des wow fadeInDown" data-wow-duration="500ms"
								data-wow-delay="0.6s">${sessionScope.loginfo_seller.sell_Name}님의 수업 결제 현황입니다!</p>
				        ...
				        <form id="contact-form search" method="get" action="${contextPath}/onedaySellOrderlist.odc" role="form">
	      						...
	      						<table class="table table-bordered table-hover dt-responsive">
							        ...
							        <thead class="thead_css">
						                <tr>
						                    ...
						                    <th colspan="2"><spring:message code="oneday.class_sell"/></th>
						                    <th><spring:message code="oneday.person_sell"/></th>
						                    <th><spring:message code="oneday.totalprice_sell"/></th>
						                </tr>
							        </thead>
