						...
						<div class="contact-form">
							...
							<form id="contact-form" method="post"
								...
								<input type="hidden" value="abcd@naver.com"
									name="c_seller_email"> <input type="hidden" name="c_no">
								<!-- ------------------------------------- [주제 type section]--------------------------------------- -->
								<label>커피 타입</label>
								...
								<div class="form-group wow fadeInDown animated"
									...
									<input type="text" placeholder="상품명" class="form-control"
										name="c_name" id="c_name" value="부룬디 은고지 무부가  워시드 235g">
								...
								<div class="form-group wow fadeInDown animated"
									data-wow-duration="500ms" data-wow-delay="0.3s"
									style="visibility: visible; animation-duration: 500ms; animation-delay: 0.3s; animation-name: fadeInDown;">
									<input type="number" placeholder="가격" class="form-control"
										name="c_price" id="c_price" value="8900"> <span
								...
								<div class="form-group wow fadeInDown animated"
									data-wow-duration="500ms" data-wow-delay="0.3s"
									style="visibility: visible; animation-duration: 500ms; animation-delay: 0.3s; animation-name: fadeInDown;">
									<input type="text" placeholder="원산지" class="form-control"
										name="c_origin" id="c_origin" value="Ngozi , Mubuga">
								...
								<div class="form-group wow fadeInDown animated"
									data-wow-duration="500ms" data-wow-delay="0.3s"
									style="visibility: visible; animation-duration: 500ms; animation-delay: 0.3s; animation-name: fadeInDown;">
									<input type="number" placeholder="무게(g)" class="form-control"
										name="c_weight" id="c_weight" value="235"> <span
								...
								<div class="form-group wow fadeInDown animated"
									data-wow-duration="500ms" data-wow-delay="0.3s"
									style="visibility: visible; animation-duration: 500ms; animation-delay: 0.3s; animation-name: fadeInDown;">
									<input type="text" placeholder="로스팅의 여부" class="form-control"
										name="c_roasting" id="c_roasting" value="City 후반"> <span
								...
								<div class="form-group wow fadeInDown animated"
									data-wow-duration="500ms" data-wow-delay="0.3s"
									style="visibility: visible; animation-duration: 500ms; animation-delay: 0.3s; animation-name: fadeInDown;">
									<input type="text" placeholder="블렌딩" class="form-control"
										name="c_blending" id="c_blending" value="Ngozi 외 1종">
								...
								<div class="form-group wow fadeInDown animated"
									data-wow-duration="500ms" data-wow-delay="0.3s"
									style="visibility: visible; animation-duration: 500ms; animation-delay: 0.3s; animation-name: fadeInDown;">
									<input type="number" placeholder="재고 수량" class="form-control"
										name="c_qty" id="c_qty" value="30"> <span
