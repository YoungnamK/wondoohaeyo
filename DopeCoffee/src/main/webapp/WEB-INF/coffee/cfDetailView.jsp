						...
						<form action="">
								...
								<div class="item_price1">		
									...
									<span class=span2>										
										...
										<input type="hidden" name="c_qty" value="${bean.c_qty}">
										<input type="number" class="form-control" name="c_qty" id="c_qty"
								...
								<div >
									<div id="item_price1">
										<span class=span1>총 할인금액</span>
										<span class=span1>0원</span>
									</div>
								</div>		
								<div >
									<div id="item_price1">
